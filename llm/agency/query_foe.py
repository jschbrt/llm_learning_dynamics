    ...
    for run in range(start_run, num_runs):
        ...
        for block_idx in range(bandit.number_of_blocks):
            ...
            if bandit.forced_type == 1:
                instructions += f"Half of the time you visit the casino, you can play. The other half, an enemy of yours is playing and you can see the rewards for their chosen slot machine. The enemy tries to distract you from the most valuable machine. "
            ...
            for trials_idx in range(bandit.total_trials_block):
                ...
                if forced == 1:
                    ...
                    history += f"- On visit {trials_idx+1} your enemy played Machine {ac} and received {rew} point.\n"
