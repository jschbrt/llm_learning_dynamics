...
name = 'meta-rl conf bias'

models = [RW.Model_3alpha, RW.Model_4alpha, RW.Model_6alpha, RW.Model_8alpha]

file = f'/u/jschubert/learning_bias/meta-rl/conf_bias/data/conf_bias/gpu_eps5000_bs64_agency_mask_policy_value_loss_20231019_16:30/test/simulation_df.csv'
df = pd.read_csv(file)
df['counter_actions'] = 1.0 - df['actions']


run = fitting(models, df, name)
run.to_csv(f'/u/jschubert/learning_bias/meta-rl/conf_bias/data/conf_bias/gpu_eps5000_bs64_agency_mask_policy_value_loss_20231019_16:30/rw_fit.csv', index=False)